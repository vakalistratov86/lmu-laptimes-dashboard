...
import {
  ChevronLeft, Timer, Trophy, Medal, ListChecks, Repeat, TrendingUp,
...
export default function DriverDetail() {
  ...
  const { data: incidentsData, isLoading: incidentsLoading } = useDriverIncidents(id);
