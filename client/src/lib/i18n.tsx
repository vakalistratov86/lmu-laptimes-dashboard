...
const ru = {
  ...
  overview: {
    ...
    heroEyebrow: "Лучший круг популярного трека",
    heroEmpty: "Нет данных о кругах на этом треке",
...
const en: Dict = {
  ...
  overview: {
    ...
    heroEyebrow: "Best lap of the popular track",
    heroEmpty: "No lap data on this track yet",
